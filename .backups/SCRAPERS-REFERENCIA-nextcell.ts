// SCRAPER NEXTCELL (API REST)
// Ubicación en proyecto: src/app/api/scrape-nextcell/route.ts
// Ruta API: POST /api/scrape-nextcell
// Método: WooCommerce REST API
// Prefijo SKU: PTT-
// Margen: 10% (1.1x)
// Salida: public/products-nextcell.json
// API: https://nextcell.com.ar/wp-json/wc/store/products
