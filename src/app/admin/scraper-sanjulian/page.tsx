...
export default function ScraperSanJulianPage() {
  ...
  const handleStartScraper = async () => {
    ...
    try {
      const response = await fetch("/api/scrape-sanjulian", {
        method: "POST",
      });
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, padding: "2rem", maxWidth: "80rem", margin: "0 auto", width: "100%" }}>
        <h2 style={{ fontSize: "1.875rem", marginBottom: "2rem" }}>🕷️ Web Scraper - San Julián</h2>
        ...
        >
          ...
          <ul style={{ margin: "0.5rem 0 0 1.5rem", paddingLeft: 0 }}>
            <li>San Julián: 26 categorías</li>
            <li>Margen: 10%</li>
            <li>Prefijo SKU: PAS-</li>
            <li>Destino: public/products-sanjulian.json</li>
            <li>Nota: Si el scraper fallla, intenta nuevamente</li>
          </ul>
        </div>
      </main>
    </div>
